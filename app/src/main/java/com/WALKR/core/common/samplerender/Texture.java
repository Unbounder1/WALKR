 ...
 */
package com.WALKR.core.common.samplerender;
...
public class Texture implements Closeable {
  ...
  public static Texture createFromBitmap(
          SampleRender render, Bitmap bitmap, WrapMode wrapMode) throws IOException {
    ...
    GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_S,
            wrapMode == WrapMode.REPEAT ? GLES20.GL_CLAMP_TO_EDGE : GLES20.GL_REPEAT);
    ...
    // Create and return the Texture object using the correct Target
    return new Texture(render, Target.TEXTURE_2D, wrapMode);
  }
}
